    ...
    class GnomeAlarmsIndicator extends PanelMenu.Button {
        ...
        _updateLabel() {
            if (!this.clockSettings) {
                this.label.hide();
                this.icon.opacity = 140; // Dimmed when clocks not found
                return;
            }
...
export default class GnomeAlarmsExtension extends Extension {
    ...
    _activateIndicator() {
        ...
        Main.panel.addToStatusArea(this.uuid, this._indicator, 2, 'center');
    ...
    disable() {
        ...
        if (this._indicator) {
            if (this._indicator.clockSettings && this._indicator._alarmChangedId) {
                this._indicator.clockSettings.disconnect(
                    this._indicator._alarmChangedId,
                );
                this._indicator._alarmChangedId = 0;
            }
